...
(function () {
  ...
  async function reverseGeocode(lat, lon) {
    ...
    const stateAbbr = stateName ? window.RRStates.abbrForName(stateName) : null;
  ...
  window.RRGeo = { browserPosition, reverseGeocode, geocodeInput, distanceMiles };
})();
